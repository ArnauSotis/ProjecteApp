...
public class ServicioTask extends AsyncTask<Void, Void, String> {
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            parametrosPost.put("usename",this.userName);
            parametrosPost.put("password",this.password);
            parametrosPost.put("vida",this.porDefecto);
            parametrosPost.put("ataque",this.porDefecto);
            parametrosPost.put("defensa",this.porDefecto);
            parametrosPost.put("resistencia",this.porDefecto);
