...
public class ServicioTask2 extends AsyncTask<Void, Void, String> {
    //variables del hilo
    ...
    public ServicioTask2(Context ctx, String linkAPI, String userName, String  password){
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            datos.add(this.userName);
            datos.add(this.password);
            parametrosPost.put("lista",datos);
